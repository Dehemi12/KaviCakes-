                        ...
                        {cart.map(item => (
                            <div key={item.id} className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <h3 className="font-bold text-lg text-gray-900 truncate">{item.productName}</h3>
                                    <div className="text-sm text-gray-500 space-y-1">
                                        <p>{item.variant.size} • {item.variant.flavor} • {item.variant.shape}</p>
                                ...
                                <div className="flex items-center gap-6 mt-4 sm:mt-0 w-full sm:w-auto justify-between sm:justify-end">
                                    ...
                                    <div className="text-right min-w-[80px]">
                                        <p className="font-bold text-pink-600">Rs.{item.price * item.quantity}</p>
                                    </div>
