export const docData = {
    masterData: {
        categories: [
            { id: 1, name: 'Birthday', basePrice: 1500 },
            { id: 2, name: 'Wedding', basePrice: 2500 },
            { id: 3, name: 'Anniversary', basePrice: 1500 },
            { id: 4, name: 'Cupcakes', basePrice: 240 },
            { id: 5, name: 'Dessert Jars', basePrice: 650 },
            { id: 6, name: 'Brownies', basePrice: 400 }
        ],
        sizes: [
    ...
    cakes: [
        ...
        },
        {
            ...
            description: 'Three-tier elegant white fondant cake with floral decorations.',
            imageUrl: 'https://placehold.co/600x600/eceff1/455a64?text=Wedding',
            ingredients: 'Flour, Butter, Sugar, Fondant, Vanilla',
            availability: true,
            categoryId: 2,
            categoryName: 'Wedding',
            basePrice: 5000,
            variants: [
                { id: 601, size: { id: 1, label: '2kg' }, shape: { id: 1, label: 'Round' }, flavor: { id: 2, label: 'Vanilla' }, price: 12000 }
            ]
        }
    ],
    orders: [
    ...
    // Add notifications for Customer side usage if needed
    notifications: [],
